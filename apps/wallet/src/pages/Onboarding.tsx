    ...
    <div className="card overflow-hidden">
      ...
      <div className="space-y-4">
        ...
        <p className="text-ink-500 max-w-md mx-auto leading-relaxed">
          Premon simulates every transaction before it touches your keys.
  ...
  return (
    <div className="card p-8 text-center space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-ink-500 max-w-md mx-auto">
          Your wallet is live on an EVM testnet. Every transaction will pass through Premon before signing.
        </p>
      </div>
