    ...
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="border-b border-ink-900/[0.06]">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center gap-2.5">
          <svg width={28} height={28} viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#141414"/><ellipse cx="16" cy="20.5" rx="11" ry="2.3" fill="#5B6169"/><path d="M7,20 C7,13 11,9.5 16,9.5 C21,9.5 25,13 25,20 Z" fill="#FFFFFF"/></svg>
          ...
          <div className="flex items-center gap-1">
            {STEPS.slice(0, -1).map((_, i) => (
              <div
                ...
                style={{ background: i <= stepIndex ? "#5B6169" : "rgba(20,20,20,0.08)" }}
              />
            ))}
          </div>
        </div>
    ...
    <div className="card overflow-hidden">
      ...
      <div className="space-y-4">
        <div className="w-16 h-16 rounded-2xl mx-auto flex items-center justify-center">
          <svg width={64} height={64} viewBox="0 0 32 32"><rect width="32" height="32" rx="8" fill="#141414"/><ellipse cx="16" cy="20.5" rx="11" ry="2.3" fill="#5B6169"/><path d="M7,20 C7,13 11,9.5 16,9.5 C21,9.5 25,13 25,20 Z" fill="#FFFFFF"/></svg>
        </div>
        ...
        <p className="text-ink-500 max-w-md mx-auto leading-relaxed">
          Baret simulates every transaction before it touches your keys.
      ...
      <div className="grid grid-cols-3 gap-3 max-w-xl mx-auto">
        {[
          ...
          { icon: Sparkles, title: "EVM Native", body: "Fast EVM — open & extensible" },
  ...
  return (
    <div className="card p-8 space-y-6 text-center">
      ...
      <div className="glass rounded-2xl p-5 max-w-md mx-auto text-left text-xs space-y-2 text-ink-600">
        ...
        <p>• Used to authorize spending from your EVM account</p>
      </div>
    ...
    <div className="card p-8 space-y-6">
      <div className="text-center space-y-3">
        ...
        <p className="text-ink-500 max-w-md mx-auto">
          ...
          copy your address and paste it into the faucet.
        </p>
      </div>
        ...
        {POLICY_TEMPLATES.map((t) => {
          ...
          return (
            <button key={t.id} onClick={() => props.onSelect(t.id)}
              ...
              style={{
                background: active ? "rgba(91, 97, 105,0.08)" : "rgba(20,20,20,0.02)",
                border: active ? "1px solid rgba(91, 97, 105,0.45)" : "1px solid rgba(20,20,20,0.08)",
              }}>
  ...
  return (
    <div className="card p-8 text-center space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-ink-500 max-w-md mx-auto">
          Your wallet is live on an EVM testnet. Every transaction will pass through Baret before signing.
        </p>
      </div>
