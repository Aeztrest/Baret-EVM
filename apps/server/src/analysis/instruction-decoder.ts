...
/**
 * Decodes an EVM transaction into a human-readable summary. An EVM tx is a
 * single top-level call, so there is normally one operation; the structure
 * stays a list to support multicall decoding later.
 */
