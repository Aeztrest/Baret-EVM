...
/**
 * EVM risk taxonomy: approval-drainer codes (ERC-20 approvals,
 * setApprovalForAll, selfdestruct, delegatecall, ownership transfer) alongside
 * the chain-agnostic codes (simulation, reputation, contract exposure, loss,
 * gas, x402).
 */
