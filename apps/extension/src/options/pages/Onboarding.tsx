/**
 * First-run onboarding wizard — single-key EOA flow for EVM chains.
 * Spec: docs/wallet-spec.md §9.
 *
 * Production-grade UX — every screen has one purpose, one CTA, plain copy.
 * Generates (or imports) a single EVM account, secures it under a passphrase,
  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-text-muted max-w-md mx-auto text-sm">
          Create a fresh EVM account, or import one you already own.
        </p>
      </div>
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-text-muted mt-0.5 leading-relaxed">
              Generate a fresh EVM account locally and back up its recovery phrase.
            </p>
          </div>
        </button>
