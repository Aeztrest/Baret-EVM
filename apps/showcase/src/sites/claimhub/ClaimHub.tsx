      ...
      <div className="min-h-screen pb-24 px-4 py-12">
        <div className="max-w-2xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
            ...
            <h1 className="text-4xl font-display font-black text-ink-900 mb-3">Chain Airdrop</h1>
            <p className="text-ink-500">Community distribution — check if your wallet is eligible for the ecosystem reward program.</p>
          </motion.div>
